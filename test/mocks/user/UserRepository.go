...
func (_m *UserRepository) Get(_a0 dddcore.UUID) (user.User, error) {
	ret := _m.Called(_a0)

	var r0 user.User
	var r1 error
	if rf, ok := ret.Get(0).(func(dddcore.UUID) (user.User, error)); ok {
		return rf(_a0)
	}
	if rf, ok := ret.Get(0).(func(dddcore.UUID) user.User); ok {
		r0 = rf(_a0)
	} else {
...
func (_m *UserRepository) Rename(_a0 user.User) error {
	ret := _m.Called(_a0)
